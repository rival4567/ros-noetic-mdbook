...
Solution package can be downloaded from here => <a href="pkg_simbha_bot.zip" download><button>Download</button></a>
...
<center><a href="bug0_algorithm.py" download><button>Download</button></a></center>
